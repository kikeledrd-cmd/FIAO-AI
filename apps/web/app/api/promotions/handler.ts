...
export function createPromotionsHandler(dependencies?: {
  ...
  return async function promotions(request: Request): Promise<NextResponse> {
    ...
    try {
      ...
      const items = await repository.listPromotions(context.ownerId);
